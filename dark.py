...
TELEGRAM_BOT_TOKEN = '7635258880:AAFfn3vPkkbSCKzIrFUz_qkw5-ymX5PYRl0'
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥chudai chalu h feedback bhej dena @Blur_anshu💥*"
    ),
    parse_mode='Markdown'
)
